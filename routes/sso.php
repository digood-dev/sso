...
Route::prefix('sso')
    ...
    ->group(function () {
        ...
        Route::middleware('web')->group(function () {
            ...
            Route::get('/sign-in/by_pat/{key}', [SsoController::class, 'sign_in_by_pat'])->name('sso.sign-in.pat');// 其它子系统通过token来登录
        ...
        Route::middleware(SsoMiddleware::class)->prefix('api')->group(function () {
            Route::get('sign-in/by_pat_token/apply', [SsoApiController::class, 'sign_in_by_pat_token']);
